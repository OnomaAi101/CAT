    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(lora_unet):
                ...
                accelerator.log("loss/model_loss", model_loss.item())
                accelerator.log("loss/cat_loss", cat_loss.item())
                # Backpropagate
...
if __name__ == "__main__":
    ...
    parser.add_argument('--tuning_config_path', type=str, default='./configs/tuning_config.json', help = "This is the json file that can contain arguments for this script. It is used for hyperparameter tuning.")
    ...
    parser.add_argument('--train_batch_size', type=int, default=44, help="")
